...
var fingerprintjsProSpa = require('@fingerprintjs/fingerprintjs-pro-spa');
var deepEquals = require('fast-deep-equal');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var deepEquals__default = /*#__PURE__*/_interopDefaultLegacy(deepEquals);
...
var FpjsContext = react.createContext(initialContext);
...
var WithEnvironment = /** @class */ (function (_super) {
    ...
    WithEnvironment.prototype.render = function () {
        ...
        return react.cloneElement(this.props.children, { env: this.detectedEnv });
    };
...
function FpjsProvider(props) {
    ...
    return (jsxRuntime.jsx(WithEnvironment, { children: jsxRuntime.jsx(ProviderWithEnv, __assign({}, propsWithEnv)) }));
}
function ProviderWithEnv(_a) {
    var _this = this;
    var children = _a.children, forceRebuild = _a.forceRebuild, cache = _a.cache, cacheTimeInSeconds = _a.cacheTimeInSeconds, cachePrefix = _a.cachePrefix, cacheLocation = _a.cacheLocation, loadOptions = _a.loadOptions, env = _a.env;
    var clientRef = react.useRef();
    var clientInitPromiseRef = react.useRef();
    var clientOptions = react.useMemo(function () {
        return {
            cache: cache,
    ...
    var createClient = react.useCallback(function () {
        ...
        var createdClient = new fingerprintjsProSpa.FpjsClient(parsedClientOptions);
        clientInitPromiseRef.current = createdClient.init();
        return createdClient;
    }, [clientOptions, env, loadOptions]);
    var getClient = react.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
    ...
    var getVisitorData = react.useCallback(function (options, ignoreCache) { return __awaiter(_this, void 0, void 0, function () {
        var client;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    var clearCache = react.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getClient()];
    ...
    return jsxRuntime.jsx(FpjsContext.Provider, __assign({ value: contextValue }, { children: children }));
}
...
function useVisitorData(getOptions, config) {
    ...
    var getVisitorData = react.useContext(FpjsContext).getVisitorData;
    var initialState = { isLoading: false };
    var _a = react.useState(initialState), state = _a[0], setState = _a[1];
    var getData = react.useCallback(function (params) {
    ...
    react.useEffect(function () {
        if (immediate && (!previousGetOptions || !deepEquals__default["default"](getOptions, previousGetOptions))) {
...
Object.defineProperty(exports, 'CacheLocation', {
    enumerable: true,
    get: function () { return fingerprintjsProSpa.CacheLocation; }
});
Object.defineProperty(exports, 'CacheStub', {
    enumerable: true,
    get: function () { return fingerprintjsProSpa.CacheStub; }
});
Object.defineProperty(exports, 'FpjsClient', {
    enumerable: true,
    get: function () { return fingerprintjsProSpa.FpjsClient; }
});
Object.defineProperty(exports, 'InMemoryCache', {
    enumerable: true,
    get: function () { return fingerprintjsProSpa.InMemoryCache; }
});
Object.defineProperty(exports, 'LocalStorageCache', {
    enumerable: true,
    get: function () { return fingerprintjsProSpa.LocalStorageCache; }
});
Object.defineProperty(exports, 'SessionStorageCache', {
    enumerable: true,
    get: function () { return fingerprintjsProSpa.SessionStorageCache; }
});
exports.FpjsContext = FpjsContext;
exports.FpjsProvider = FpjsProvider;
exports.useVisitorData = useVisitorData;
//# sourceMappingURL=fp-pro-react.cjs.js.map
